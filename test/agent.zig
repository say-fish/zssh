...
test "decode Unlock" {
    // 00 00 00 08 17 00 00 00 03 31 32 33              .........123
...
test {
    // 00 00 00 f0 1b 00 00 00 18 73 65 73 73 69 6f 6e  .........session
    // 2d 62 69 6e 64 40 6f 70 65 6e 73 73 68 2e 63 6f  -bind@openssh.co
    // 6d 00 00 00 33 00 00 00 0b 73 73 68 2d 65 64 32  m...3....ssh-ed2
    // 35 35 31 39 00 00 00 20 11 df f7 5f 5b a3 f8 56  5519... ..._[..V
    // 08 aa 42 aa 7b 7d 74 e5 05 2b 9d e0 e5 eb 0f 16  ..B.{}t..+......
    // a4 d9 e2 64 c6 77 7f c3 00 00 00 40 4b d3 c6 ca  ...d.w.....@K...
    // eb a6 c9 86 ee 45 0a 03 fb 8b 60 fb af 9f 40 25  .....E....`...@%
    // 09 72 5d e8 8c c6 b3 10 0b 13 06 41 72 41 77 69  .r]........ArAwi
    // 16 b5 94 65 4e ac 47 b0 0c 97 59 f5 bd d2 23 4c  ...eN.G...Y...#L
    // 41 f3 2b 3d aa bb bb 6e ad 04 bf db 00 00 00 53  A.+=...n.......S
    // 00 00 00 0b 73 73 68 2d 65 64 32 35 35 31 39 00  ....ssh-ed25519.
    // 00 00 40 0b b7 0e dc d5 6b 5e e4 40 03 7d 58 13  ..@.....k^.@.}X.
    // 9a ce df 49 d7 54 c8 6a ac 46 7f 3d ac b1 ec e8  ...I.T.j.F.=....
    // aa 0e 25 cf 29 e6 d8 49 1d f3 a4 17 f9 8d d1 b2  ..%.)..I........
    // 5e 94 b6 c0 4f b3 90 88 42 c4 2c 1e e9 a4 0c 7c  ^...O...B.,....|
    // 4e c0 07 00                                      N...
    const bytes = [_]u8{  };

    const msg = try decode(Client, &bytes);

    std.debug.print("{any}\n", .{msg.extension.@"session-bind@openssh.com"});
}

test "decode AddIdConstrained" {
    // 00 00 00 8a 19 00 00 00 0b 73 73 68 2d 65 64 32  .........ssh-ed2
    // 35 35 31 39 00 00 00 20 c2 d0 30 d1 19 0f 4d bd  5519... ..0...M.
    // e4 c1 57 27 2e 0a b7 0a 68 69 a4 ec d9 ec 68 ef  ..W'....hi....h.
    // 7f 3a 6a da 93 31 39 4f 00 00 00 40 2e 42 1c d6  .:j..19O...@.B..
    // 38 ab f3 1e 5c 3e 02 61 20 e5 b4 a5 36 7a e3 45  8...\>.a ...6z.E
    ...
    // 19 0f 4d bd e4 c1 57 27 2e 0a b7 0a 68 69 a4 ec  ..M...W'....hi..
    // d9 ec 68 ef 7f 3a 6a da 93 31 39 4f 00 00 00 09  ..h..:j..19O....
    // 6c 6f 63 61 6c 68 6f 73 74 01 00 00 00 0a        localhost.....
    const bytes = [_]u8{  };

    const refrences = [_]zssh.agent.AddIdConstrained.Constraint{
        .{ .lifetime = .{ .sec = 10 } },
    };
...
test "decoded AddIdConstrained" {
    // 00 00 00 8b 19 00 00 00 0b 73 73 68 2d 65 64 32  .........ssh-ed2
    // 35 35 31 39 00 00 00 20 c2 d0 30 d1 19 0f 4d bd  5519... ..0...M.
    // e4 c1 57 27 2e 0a b7 0a 68 69 a4 ec d9 ec 68 ef  ..W'....hi....h.
    // 7f 3a 6a da 93 31 39 4f 00 00 00 40 2e 42 1c d6  .:j..19O...@.B..
    // 38 ab f3 1e 5c 3e 02 61 20 e5 b4 a5 36 7a e3 45  8...\>.a ...6z.E
    ...
    // 19 0f 4d bd e4 c1 57 27 2e 0a b7 0a 68 69 a4 ec  ..M...W'....hi..
    // d9 ec 68 ef 7f 3a 6a da 93 31 39 4f 00 00 00 09  ..h..:j..19O....
    // 6c 6f 63 61 6c 68 6f 73 74 01 00 00 00 0a 02     localhost......
    const bytes = [_]u8{  };
